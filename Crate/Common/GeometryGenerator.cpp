...
GeometryGenerator::MeshData GeometryGenerator::CreateBoxGrass(float width, float height, float depth, uint32 numSubdivisions)
{
	MeshData meshData;
...
GeometryGenerator::MeshData GeometryGenerator::CreateSkyBox(float width, float height, float depth, uint32 numSubdivisions)
{
	MeshData meshData;
